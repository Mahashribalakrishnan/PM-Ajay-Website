...
const sampleCards = [
  ...
  { id: 3, name: 'Sunita Devi', caste: 'SC', income: '₹60,000', scheme: 'Housing', image: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/1f469.svg', status: 'pending' },
  ...
  return (
    <div className={`homepage ${isDarkMode ? 'dark' : 'light'} ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <main className="content" aria-label="Approve beneficiaries content">
        ...
        <header className="content-header">
          <div className="header-top">
            ...
            <div className="ap-header-actions">
              ...
              <div className="ap-language-group" ref={languageRef}>
                <button
                  type="button"
                  className="ap-language-toggle"
                  aria-haspopup="listbox"
                  aria-expanded={showLanguages ? 'true' : 'false'}
                  onClick={() => setShowLanguages((prev) => !prev)}
                >
                  <span className="ap-language-icon">
                ...
                {showLanguages && (
                  <ul className="ap-language-dropdown" role="listbox">
        ...
        <div className={`ap-wrapper ${isDarkMode ? 'dark' : 'light'}`}>
              ...
              {filteredCards.map((c) => (
                <article key={c.id} className="ap-card">
                  <div className="ap-card-media">
                    <div className="ap-avatar-placeholder" aria-hidden="true">
                      <svg viewBox="0 0 96 96">
                        <circle cx="48" cy="35" r="18" />
                        <path d="M48 56c-16 0-28 11-28 27v7h56v-7c0-16-12-27-28-27Z" />
                      </svg>
                    </div>
                    {c.status === 'verified' && (
